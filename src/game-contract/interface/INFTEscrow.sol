...
interface INFTEscrow {
    ...
    event NFTDeposited(uint256 indexed tokenId, address indexed user);
    event NFTWithdrawed(uint256 indexed tokenId, address indexed user);
    event TokenDeposited(uint256 indexed amount, address indexed user);
    event TokenWithdrawed(uint256 indexed amount, address indexed user);
