...
describe("ReNFT Contract", function () {
  var bnbContract:BNB, e721Contract:E721, usdcContract:USDC, reNFTContract:ReNFT, resolverContract:Resolver   ;
  ...
  context("Start", function(){
      it("should it work", async function(){
        ...
        resolverContract.connect(this.owner).setPaymentToken(1,bnbContract.address);
        resolverContract.connect(this.owner).setPaymentToken(2,usdcContract.address);
